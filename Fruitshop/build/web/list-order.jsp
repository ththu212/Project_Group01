    ...
    <body>
                        ...
                        <tr>
                            ...
                            <td class="align-middle text-center">
                                <c:if test="${order.status == 1}">
                                    <span class="text-white w-50 bg-primary p-1 rounded ">Wait for confirmation</span>
                                </c:if>
                                <c:if test="${order.status == 0}">
                                    <span class="text-white bg-danger w-50 pr-4 pl-4 pt-1 pb-1 rounded">Canceled</span>
                                </c:if>
                                <c:if test="${order.status == 2}">
                                    <span class="text-white w-50 w-50 pr-4 pl-4 pt-1 pb-1 rounded bg-success">Order success</span>
                                </c:if>
                            </td>
                            <td class="align-middle text-center">${order.quantity}</td>
                            <td class="align-middle text-center">${order.amount}VND</td>
                            ...
                            <td class="align-content-between text-right">
                                <c:url var="huy" value="listorder">
                                    ...
                                    <c:param name="action" value="huyOrder" />
                                </c:url>
                                <c:if test="${order.status == 1}">
                                    <button id="showPopupButton" class="btn btn-danger showPopupButton mr-3" data-order-link='${huy}' onclick="transferData(this)">
                                        Cancel </button>
                                    <button class="update-button showButton btn btn-info mr-3" data-target="elementToToggle"
        ...
        <div id="elementToToggle" class="update pt-150 pb-150">
            <div class="update-content container vh-100">
                ...
                <form action="listorder" method="get" id="formUpdate">
                    <div class="row">
        ...
        <div class="main-popup w-100 h-100" id="myPopup">
            <div class="popup w-25">
                ...
                <p>Do you want to sure cancel ?</p>
